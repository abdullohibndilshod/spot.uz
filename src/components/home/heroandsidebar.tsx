...
const mainArticles: MainArticle[] = [
  ...
  },
  {
    time: "Bugun, 12:30",
    category: "Jamiyat",
    title: "Yangi avtomobil raqamlari qoidalari: haydovchilar nimani bilishi kerak?",
    summary: "Ichki ishlar vazirligi yangi tizimni joriy etish haqida ma'lumot berdi.",
    imageUrl: "/src/image/img5.png"
  },
  {
    time: "Bugun, 12:20",
    category: "Texnologiya",
    title: "O'zbekistonda 5G tarmog'ining sinovdan o'tkazilishi: qaysi shaharlar birinchi bo'ladi?",
    summary: "Mobil operatorlar uskunalar o'rnatishni boshladi, tezlik sinovlari ijobiy natija berdi.",
    imageUrl: "/src/image/img6.png"
  }
];

const bannerData: BannerProps = {
  bannerImageUrl: "/src/image/agrobank.png"
};
